    ...
    <app-page-shell innerClassName="flex items-center justify-center min-h-[calc(100vh-80px)]">
      <div class="w-full max-w-[1100px] mx-auto py-16 px-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          <!-- Free -->
          <div class="glass-card rounded-2xl p-8 md:p-10 flex flex-col relative overflow-hidden">
          ...
          <!-- Monthly -->
          <div class="glass-card rounded-2xl p-8 md:p-10 flex flex-col border border-white/5 relative overflow-hidden">
          ...
          <!-- Annual -->
          <div class="glass-card rounded-2xl p-8 md:p-10 flex flex-col md:-translate-y-3 relative overflow-hidden"
