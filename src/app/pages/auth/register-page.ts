        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()" class="flex flex-col">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6">
            ...
            <div class="auth-v2-input-group">
              ...
              <input id="fullName" type="text" formControlName="fullName" placeholder="" class="auth-v2-input" />
            ...
            <div class="auth-v2-input-group">
              ...
              <input id="email" type="email" formControlName="email" placeholder="" class="auth-v2-input" />
          ...
          <div class="flex flex-col gap-3">
            <button type="button" (click)="continueWithGoogle()" class="auth-v2-btn-secondary !mt-0 !text-white/60 !border-white/10 hover:!bg-white/5">
...
export class RegisterComponent {
  ...
  continueWithGoogle(): void {
    ...
    console.log('Initiating Google OAuth from register page with nonce:', nonce);
