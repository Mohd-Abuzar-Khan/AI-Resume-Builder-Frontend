import { Component, inject, ChangeDetectionStrategy, computed, OnInit, signal } from '@angular/core';
        ...
        @if (loading()) {
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            @for (res of resumes(); track res.resumeId) {
              <div class="glass-card rounded-3xl overflow-hidden group cursor-pointer transition-all hover:shadow-md" style="border-color: rgba(255, 240, 230, 0.18);">
                <!-- Resume preview area -->
